#' @title Generate Treatment Assignment
#' @description Randomly generate treatment assignment according to the method in Jiang et al.(2022).
...
#' @examples
#' CovAdptRnd(rndflag = 1, S = matrix(sample(1:4,100,TRUE)), pi = 0.5)
#' CovAdptRnd(rndflag = 2, S = matrix(sample(1:4,100,TRUE)), pi = 0.5)
#' CovAdptRnd(rndflag = 3, S = matrix(sample(1:4,100,TRUE)), pi = 0.5)
#' CovAdptRnd(rndflag = 4, S = matrix(sample(1:4,100,TRUE)), pi = 0.5)
#'
